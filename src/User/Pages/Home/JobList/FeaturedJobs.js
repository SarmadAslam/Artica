  ...
  const featuredJobs = [
    {
      ...
      jobDescription: "Traditional Artist for Custom Portraits",
      ...
      experience: "2+ years of art experience",
      Notes: "Looking for artists specializing in portraits"
    },
    {
      id: 2,
      companyImg: jobImage2,
      jobDescription: "Graphic Designer for Art Portfolio Website",
      companyName: "Artica Design Agency",
      location: "Remote",
      salary: "400-600 USD",
      partTime: true,
      timing: "Part Time",
      ...
      badges: [],
      experience: "1-3 years of design experience",
      Notes: "Experience with React preferred"
    },
    {
      id: 3,
      companyImg: jobImage3,
      jobDescription: "Event Coordinator for Virtual Art Exhibitions",
      companyName: "Artica Exhibitions",
      location: "Remote",
      salary: "800-1200 USD",
      freelancer: true,
      timing: "Freelance",
      ...
      addclassNameBookmark: true,
      badges: [],
      experience: "3+ years in event management",
      Notes: "Experience with virtual events preferred"
    },
    {
      id: 4,
      companyImg: jobImage4,
      jobDescription: "Marketing Manager for Art Platform",
      companyName: "Artica Marketing Team",
      location: "Remote",
      salary: "1500-2400 USD",
      fullTime: true,
      timing: "Full Time",
      catogary: "Featured Jobs",
      addclassNameBookmark: false,
      badges: [],
      experience: "2-4 years in marketing",
      Notes: "Looking for individuals with a passion for the arts"
    }
  ];
