  ...
  const freelancer = [
    {
      ...
      jobDescription: "Traditional Art Commission",
      companyName: "Art Creations Ltd.",
      location: "New York City, NY",
      salary: "500-800/project",
      freelancer: true,
      timing: "Freelance",
      ...
      Notes: "Experience with watercolors and oil painting is preferred."
    },
    {
      id: 2,
      companyImg: jobImage2,
      jobDescription: "Custom Portrait Painting",
      companyName: "Canvas Dreams",
      location: "Los Angeles, CA",
      salary: "300-500/project",
      freelancer: true,
      timing: "Freelance",
      category: "Traditional Art",
      addclassNameBookmark: false,
      ...
      Notes: "Looking for an artist to create family portraits."
    },
    {
      id: 3,
      companyImg: jobImage3,
      jobDescription: "Art Instructor for Workshops",
    ...
    },
    {
      ...
      jobDescription: "Art Exhibition Curator",
      companyName: "Gallery Collective",
      location: "Chicago, IL",
      salary: "2000-3000/project",
      freelancer: true,
      timing: "Freelance",
