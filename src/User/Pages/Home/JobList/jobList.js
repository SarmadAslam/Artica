          ...
          <Row className="justify-content-center">
            <Col lg={6}>
              <div className="section-title text-center mb-4 pb-2">
                <h4 className="title">Explore Art Opportunities</h4>
                <p className="text-muted mb-1">
                  Discover exciting art-related projects and freelance jobs tailored to your skills and interests.
                </p>
              </div>
            </Col>
          </Row>
