  ...
  const blogPost = [
    {
      ...
      blogTitle: "How to Build a Successful Artist Portfolio",
    ...
    },
    {
      ...
      blogTitle: "Navigating the Freelance Art Market: Tips & Insights",
      blogAuthor: "Adam Gibson",
      blogDate: "5 mins ago"
    },
    {
      id: 3,
      blogPostImage: blogImage6,
      blogTitle: "The Importance of Art Competitions for Emerging Artists",
      blogAuthor: "Rebecca Swartz",
      blogDate: "5 mins ago"
    }
  ];
                ...
                <Card className="blog-modern-box overflow-hidden border-0">
                  ...
                  <div className="card-img-overlay">
                    ...
                    <p className="card-text text-white-50">
                      {" "}
                      <Link to="/blogauthor" className="text-white-50">
                        {blogPostDetails.blogAuthor}
                      </Link>{" "}
