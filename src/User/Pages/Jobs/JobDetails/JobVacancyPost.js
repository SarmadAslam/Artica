  ...
  const jobVacancyPost = [
    {
      ...
      jobDescription: "Traditional Art Sales Specialist",
      experience: "1-3 Yrs Exp.",
      companyName: "Artistic Creations Ltd.",
      location: "New York",
      salary: "$300 - $1000 / month",
      fullTime: true,
      timing: "Full Time",
    ...
    },
    {
      ...
      jobDescription: "Art Gallery Manager",
      experience: "3-5 Yrs Exp.",
      companyName: "Creative Art Hub",
      location: "California",
      salary: "$500 - $1500 / month",
      partTime: true,
      timing: "Part Time",
    ...
    },
    {
      ...
      jobDescription: "Freelance Art Curator",
      experience: "2-4 Yrs Exp.",
      companyName: "Global Art Solutions",
      location: "Remote",
  ...
  return (
    <React.Fragment>
      ...
      <div className="text-center mt-4">
        <Link to="/jobs" className="primary-link form-text">
