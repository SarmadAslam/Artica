...
// // Extend with _id since it's not in ExhibitionType
// type ExhibitionWithId = ExhibitionType & { _id: string };

// // Map status to UI style classes
...
//                   {exhibition.title}
//                 </h3>
//                 {/* <span className={`text-sm font-medium px-3 py-1 rounded-full ${statusStyles[statusLabel]}`}>
//                   {statusLabel}
//                 </span> */}
...
//                     : "bg-[#421983] hover:bg-[#361466]"
//                 }`}
//               >
//                 {isClosed ? "Closed" : "Participate"}
//               </button>
//             </div>
//           );
//         })}
...
export default function ExhibitionsGrid() {
  ...
  const handleParticipateClick = (exhibitionTitle: string) => {
    // Navigate to the ParticipateInExhibition page with the exhibition title
    navigate(`/participate?title=${encodeURIComponent(exhibitionTitle)}`);
  };
          ...
          return (
            ...
            >
              ...
              <button
                ...
                onClick={() => handleParticipateClick(exhibition.title)}
              >
                {isClosed ? "Closed" : "Participate"}
              </button>
            </div>
